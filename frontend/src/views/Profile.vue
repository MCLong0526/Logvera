...
<template>
  <div class="max-w-xl">
    <h1 class="mb-5 text-2xl font-semibold text-slate-800">Profile</h1>
    <div class="card p-6">
      <div class="mb-6 flex items-center gap-4">
        <Avatar :name="form.name" size="lg" />
        <div>
          <p class="text-lg font-semibold text-slate-800">{{ form.name }}</p>
      ...
      <form class="space-y-4" @submit.prevent="save">
        ...
        <p class="text-sm text-slate-500">Change password (leave blank to keep current)</p>
